                ...
                <div className="container-fostrap">
                    ...
                    <div className="content">
                        <div className="container">
                            <div className="row">
                                <ProjectSection img="newmun.PNG" redirect="viz/newmun" title="Registered Citizens per Sexe & Age" description="Visualizing registered citizens per Age and Sexe until 10-07-2017 - Municipal Map -  (data provided by ISIE)" />
