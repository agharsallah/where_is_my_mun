                    ...
                    <div className="content">
                        <div className="container">
                            <div className="row">
                                ...
                                <ProjectSection img="daily_reg_line.PNG" redirect="viz/dailyregcharts" title="Daily Registration Number (Charts)  " description="Analyzing the registration and updates of the municipal election density in Time -data Daily updatable- (data provided by ISIE)" />
