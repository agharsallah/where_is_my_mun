...
var INITIAL_LOCATION = {
  address: 'Rue moez ibn badis, Kairouan',
  position: {
    latitude: 36.8649386,
    longitude: 10.210816399999999
  }
};
              ...
              <div className="row">
                <div className="col-xs-8 col-sm-10">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control input-lg" id="address" placeholder="Rue Moez ibn badis, kairouan" ref={this.setSearchInputElementReference} required />
                  </div>
